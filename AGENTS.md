...
- O formato dos testes é uma lista de cenários contendo `comando` ou `comandos` (e opcionalmente `entrada`), ou uma lista `navegação` de passos contendo `endereço` (para cenários de navegador).
